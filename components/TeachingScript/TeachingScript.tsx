...
const TeachingScript = () => {
  ...
  return (
    <div className="px-auto flex h-full flex-col items-start md:px-3">
      ...
      {!expandedTs && (
        <>
          <div className="flex flex-row items-center justify-between md:hidden w-[90%] mx-auto">
            <h1 className="text-[#6E808E] text-[14px] leading-[18px] font-montHeavy">Your scripts</h1>
            <div className="flex flex-row items-center gap-2">
              <button className="rounded-[10px] bg-[#83D5D6] p-[10px] w-auto h-auto">
          ...
          <div className="mx-auto mt-2 md:mt-5 flex h-full flex-col items-start gap-2">
