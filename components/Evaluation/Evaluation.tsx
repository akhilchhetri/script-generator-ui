...
const ScriptComponent = ({ data, key, setActiveScript, setExpandedEv }: any) => {
  ...
  return (
    <div className="relative md:pr-[25px] md:pt-[25px]" key={key}>
      <div className="relative flex h-[210px] cursor-pointer  flex-col overflow-hidden rounded-[25px] bg-[#FFFFFF26] p-3 px-5 pb-5 shadow-md sm:h-[325px] sm:w-[234px] md:bg-white">
        ...
        <button
          ...
          className="absolute bottom-5 left-5 z-10 mt-1 w-[70%] rounded-[15px] bg-[#66C7C9] p-2 text-left text-[12px] font-[800] text-white sm:mt-3"
        >
          View details.
        </button>
        <Image
          className="z-1 absolute bottom-0 right-0 w-[90%] md:w-[80%]"
